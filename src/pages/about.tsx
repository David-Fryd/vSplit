    ...
    <div className="flex h-screen w-full items-center justify-center border-2 bg-neutral-900">
      <div className="flex h-screen w-1/2 flex-col items-center justify-center  p-2  text-neutral-50">
        ...
        <p className="text-justify text-lg">
          ...
          "splitting" of groups is tedious, and the best way of doing it
          currently is sitting down and manually drawing out what you want the
          "split" to be. there are many different standard splits, and splits
          that are specific to events, making it difficult for controllers to
          know how to hand off aircraft and who is currently responsible for a
          given piece of airspace. This tool allows controllers to see what the
          split looks like at any given time by enabling ARTCCs to define their
          sectors, and for authenticated/authorized controllers to shuffle
          around the groupings of sectors.
        </p>
      </div>
    </div>
  );
